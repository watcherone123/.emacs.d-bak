...
(lazy-one-key-create-menu "Toggle"
			  (:key "F" :description "Toggle bit font" :command +sky/toggle-big-font :filename "init-ui")
			  (:key "w" :description "Toggle write room" :command writeroom-mode :filename "init-writeroom")
			  (:key "p" :description "Toggle proxy" :command +sky/toggle-proxy :filename "init-better-default")
			  (:key "l" :description "Toggle line numbers" :command display-line-numbers-mode :filename "display-line-numbers")
			  (:key "t" :description "Toggle telega" :command +sky/toggle-telega :filename "init-telega")
...
(lazy-load-global-keys '(("M-x" . smex+))
		       "init-smex")
(provide 'init-key)