;;; ts-c-mode.el --- tree-sitter support for C and C++  -*- lexical-binding: t; -*-
...
(defcustom c-ts-mode-indent-offset 4
...
;;;###autoload
(define-derived-mode c-ts-base-mode c-mode "C"
...
;;;###autoload
(define-derived-mode sniper-c-ts-mode c-ts-base-mode "C"
  "Major mode for editing C, powered by tree-sitter."
  :group 'c
